 ...
 *
 * <p>{@link DataComponentType.Valued} and {@link DataComponentType.NonValued} are
 * nested marker interfaces that distinguish components with an associated value from
 * presence-only components.
 */
