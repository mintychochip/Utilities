...
public interface Scoreboard {
  ...
  @NotNull
  Set<? extends Objective> objectives();

  @NotNull
  Set<? extends Objective> objectivesByCriteria(@NotNull Criteria criteria);

  @NotNull
  Set<? extends Team> teams();

  @NotNull
  Set<String> entries();

  @Nullable
  Objective objective(@NotNull String name);

  @Nullable
  Objective objective(@NotNull DisplaySlot slot);

  @Nullable
  Team team(@NotNull String name);

  @Nullable
  Team entryTeam(@NotNull String entry);

  @NotNull
  Set<? extends Score> scores(@NotNull String entry);
  ...
  @NotNull
  Team registerTeam(@NotNull String name);
