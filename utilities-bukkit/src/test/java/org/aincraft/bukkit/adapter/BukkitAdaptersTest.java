...
class BukkitAdaptersTest {
  ...
  void testDataComponentTypesOnItemMeta() {
    ...
    org.bukkit.inventory.meta.ItemMeta bMeta =
    ...
    DataComponentType<Integer> intType =
        createComponentType(Key.key("custom", "custom_model_data"), Integer.class);
    DataComponentType<Boolean> boolType =
        createComponentType(Key.key("custom", "glowing"), Boolean.class);
    ...
    DataComponentType<Thread> unsupportedType =
        createComponentType(Key.key("custom", "thread"), Thread.class);
    assertThrows(
        UnsupportedOperationException.class, () -> meta1.setData(unsupportedType, new Thread()));
  ...
  void testStrictUnwrappingThrowsOnForeignImplementations() {
    ...
    World foreignWorld =
        new World() {
          ...
          @Override
          public java.util.Collection<? extends Chunk> loadedChunks() {
            return java.util.List.of();
          }
        };
    ...
    ItemStack foreignItem =
        new ItemStack() {
          @Override
          public ItemType type() {
            return foreignItemType;
          }
          ...
          @Override
          public java.util.List<net.kyori.adventure.text.Component> lore() {
            return null;
          }
    ...
    Inventory foreignInv =
        new Inventory() {
          ...
          @Override
          public java.util.Map<Integer, ItemStack> removeItem(ItemStack... items) {
            return java.util.Map.of();
          }
    ...
    Server foreignServer =
        new Server() {
          ...
          @Override
          public java.util.Collection<? extends Player> onlinePlayers() {
            return java.util.List.of();
          }

          @Override
          public java.util.Collection<? extends World> worlds() {
            return java.util.List.of();
          }

          @Override
          public World world(Key key) {
            return null;
          }
  ...
  void testAttributeAdaptation() {
    org.bukkit.attribute.Attribute bAttr =
    ...
    org.bukkit.attribute.AttributeModifier bMod =
        new org.bukkit.attribute.AttributeModifier(
            NamespacedKey.minecraft("test_mod"),
            5.0,
